...
function JSONRpcClient_kick_async()
{
    ...
    {
        thread = new BrowserThread();
        thread.nativeFunction = JSONRpcClient._async_handler;
        thread.startThread();
    }
};
...
function JSONRpcClient_sendRequest(req)
{
    ...
    // System.out.println("opening for: " + req.cb);
    // System.out.println("Callback?: " + (req.cb != null));
    ...
    {
        System.out.println("Exception starting request");
        // http.open("POST", this.serverURL, (req.cb != null), this.customer, this.pass);
    }
